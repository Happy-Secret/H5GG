 ...
 * Compile with:
 *
 * clang -target arm64-apple-ios8.0 -isysroot /Applications/Xcode_13.2.1.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS15.2.sdk frida-core-example.c -o frida-core-example -L. -lfrida-core -lbsm -ldl -lresolv -lm -Wl,-framework,Foundation,-framework,CoreGraphics,-framework,UIKit,-dead_strip
 *
